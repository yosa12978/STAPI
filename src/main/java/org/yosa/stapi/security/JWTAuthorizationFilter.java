...
import static org.yosa.stapi.security.SecurityConstants.*;
        ...
        if (token != null) {
            ...
            if (user != null){
                ...
                for(String i : roles.split(","))
                    user_roles.add(new SimpleGrantedAuthority(i));

                return new UsernamePasswordAuthenticationToken(user, null, user_roles);
            }
            return null;
        }
        return null;
